...
if (sizeof($val->errors) > 0) {
    ...
    if ($mehandi >= 1) {
        echo "<script>alert('Record updated successfully!');window.location='mehandi-profile.php';</script>";
    } else {
        echo "<script>alert('Sorry! something went wrong...');window.location='mehandi-profile-update.php?mehandi_id=$mehandi_id';</script>";
    }
}
?>
