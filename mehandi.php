            ...
            <div class="row">
                ...
                <div class="col-md-9 col-lg-9 col-sm-12">
                    <div class="right-side"><?php
                        foreach ($mehandi as $design) {
                            ?>

                            <div class="venues-slide first">

                                <div class="img"><img src="./admin/logos/<?php echo $design['logo']; ?>" style="height: 230px;"></div>
                                <div class="text">
                                    <h3><b><?php echo ucwords($design['mehandi_class_name']); ?></b> </h3>
                                    <div class="address" style="color: red;"><?php echo $design['address']; ?>, <?php echo $design['city']; ?></div>
                                    <div class="address" style="color: red;">Contact No.: <?php echo $design['mobile']; ?></div>
                                    <div class="address" style="color: red;">Type.: <?php echo $design['type']; ?></div>
                                    <div class="address" style="color: red;">Rate.: <?php echo $design['rate']; ?></div>
                                    ...
                                    if (isset($_SESSION['web_user'])) {
                                        ?>
                                        <div class="button">
                                            <a href="mehandi-book.php?register_id=<?php echo $register_id; ?>&mehandi_id=<?php echo $design['mehandi_id']; ?>" class="btn">Book Now</a>
                                        </div>
                                        <?php
                                    } else {
                                        ?>
