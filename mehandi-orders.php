...
$booking = $db->select("book", "*", ["AND" => ['mehandi_id' => $user1['mehandi_id'], 'deleted' => 0]]);
?>
                ...
                <div class="tab-content profile-con open">
                    <table class="booking-viewTable">
                        ...
                        foreach ($booking as $book) {
                            ...
                            $mehandi = $db->select("mehandi", "*", ["AND" => ['mehandi_id' => $book['mehandi_id'], 'deleted' => 0]])[0];
                            // $user = $db->select("users", "*", ["AND" => ['hotel_id' => $hotel['hotel_id'], 'type' => "hotel"]])[0];
