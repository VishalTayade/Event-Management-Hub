<?php
include './header.php';
$parlour = $db->select("parlours", "*", ["deleted" => 0]);
?>
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-lg-9 col-sm-12">
                    <div class="right-side"><?php
                        foreach ($parlour as $hair) {
                            ?>

                            <div class="venues-slide first">

                                <div class="img"><img src="./admin/logos/<?php echo $hair['logo']; ?>" style="height: 230px;"></div>
                                <div class="text">
                                    <h3><b><?php echo $hair['parlour_name']; ?></b> </h3>
                                    <div class="address" style="color: red;"><?php echo $hair['address']; ?>, <?php echo $hair['city']; ?></div>
                                    <div class="address" style="color: red;">Contact No.: <?php echo $hair['mobile']; ?></div>
                                    <div class="address" style="color: red;">For.: <?php echo $hair['for']; ?></div>
                                    <div class="address" style="color: red;">Rate.: <?php echo $hair['rate']; ?></div>
                                    <br>
                                    <br>
                                    <?php
                                    if (isset($_SESSION['web_user'])) {
                                        ?>
                                        <div class="button">
                                            <a href="makeup-book.php?register_id=<?php echo $register_id; ?>&parlour_id=<?php echo $hair['parlour_id']; ?>" class="btn">Book Now</a>
                                        </div>
                                        <?php
                                    } else {
                                        ?>
