...
$booking = $db->select("book", "*", ["AND" => ['photo_id' => $user1['photo_id'], 'deleted' => 0]]);
?>
                ...
                <div class="tab-content profile-con open">
                    <table class="booking-viewTable">
                        ...
                        foreach ($booking as $book) {
                            ...
                            $photo = $db->select("photographerss", "*", ["AND" => ['photo_id' => $book['photo_id'], 'deleted' => 0]])[0];
                            //$user = $db->select("users", "*", ["AND" => ['photo_id' => $photo['photo_id'], 'type' => "photo"]]);
