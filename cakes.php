<?php
include './header.php';
$cakes = $db->select("cakes", "*", ["deleted" => 0]);
?>
                    ...
                    <div class="right-side"><?php
                        foreach ($cakes as $cake) {
                            ...
                            <div class="venues-slide first">
                                ...
                                <div class="img"><img src="./admin/logos/<?php echo $cake['logo']; ?>" style="height: 230px;"></div>
                                <div class="text">
                                    <h3><b><?php echo ucwords($cake['cake_shop_name']); ?></b> </h3>
                                    <div class="address" style="color: red;"><?php echo $cake['address']; ?>, <?php echo $cake['city']; ?></div>
                                    <div class="address" style="color: red;">Contact No.: <?php echo $cake['mobile']; ?></div>
                                    <div class="address" style="color: red;">Type.: <?php echo $cake['type']; ?></div>
                                    <div class="address" style="color: red;">Rate.: <?php echo $cake['rate']; ?></div>
                                    ...
                                    if (isset($_SESSION['web_user'])) {
                                        ?>
                                        <div class="button">
        <!--                                            <a href="cake-book.php?register_id=<?php echo $register_id; ?>&cake_id=<?php echo $cake['cake_id']; ?>" class="btn">Book Now</a>-->
                                        </div>
                                        <?php
                                    } else {
                                        ?>
