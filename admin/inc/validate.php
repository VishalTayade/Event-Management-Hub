...
class validation{
    ...
    */
    ...
    private function validatePassword($var, $min=0, $max=0, $required=false)
    {
        if($required==false && strlen($this->source[$var]) == 0)
        {
            return true;
    ...
    {
        $this->sanitized[$var] = (string) filter_var($this->source[$var], FILTER_SANITIZE_NUMBER_INT);
    }
    ...
    {
        $this->sanitized[$var] = md5((string) filter_var($this->source[$var], FILTER_SANITIZE_STRING));
    }
