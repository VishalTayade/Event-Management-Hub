...
<div class="site-content">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="m-y-0">Add Music</h3>
        </div>
        <div class="panel-body">
            <form id="reg-form" data-toggle="validator" action="music-save.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-4">
                        <span class="form-group">
                            <label  for="form-control-3">Music Name<span style="color: red">&nbsp;*</span></label>
                            <input id="name" class="form-control b-a-2" name="music_name" placeholder="Enter Music Name" type="text" required>
                        </span>
                    </div>
                    <div class="col-sm-4">
                        <span class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <span class="form-group">
                            <label class="" for="form-control-1">Rate<span style="color: red">&nbsp;*</span></label>
