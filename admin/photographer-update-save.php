...
if (sizeof($val->errors) > 0) {
    ...
    if ($photo <= 1) {
        echo "<script>alert('Record updated successfully!');window.location='photographer-manage.php';</script>";
    } else {
        echo "<script>alert('Sorry! something went wrong...');window.location='photographer-update.php?photo_id=$photo_id';</script>";
    }
}
?>
