...
if (sizeof($val->errors) > 0) {
    ...
    if ($parlour >= 1) {
        echo "<script>alert('Record Updated successfully!');window.location='parlour-manage.php';</script>";
    } else {
        echo "<script>alert('Sorry! something went wrong...');window.location='parlour-update.php?parlour_id=$parlour_id';</script>";
    }
}
?>
