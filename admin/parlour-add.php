...
<div class="site-content">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="m-y-0">Add Beauty Parlour</h3>
        </div>
        <div class="panel-body">
            <form id="reg-form" data-toggle="validator" action="parlour-save.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-4">
                        <span class="form-group">
                            <label  for="form-control-3">Parlour Name<span style="color: red">&nbsp;*</span></label>
                            <input id="name" class="form-control b-a-2" name="parlour_name" placeholder="Enter Parlour Name" type="text" required>
                        </span>
                    </div>
                    <div class="col-sm-4">
                        <span class="form-group">
                            <label  for="form-control-3">Parlour Address<span style="color: red">&nbsp;*</span></label>
                            <input id="name" class="form-control b-a-2" name="address" placeholder="Enter Parlour Address" type="text" required>
                        </span>
                    </div>
                    <div class="col-sm-4">
                        <span class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <span class="form-group">
                            ...
                            <input  class="form-control b-a-2" name="rate" placeholder="Enter Rate" required="">
                        </span>
                    </div>
                    <div class="col-sm-4">
                        <span class="form-group">
