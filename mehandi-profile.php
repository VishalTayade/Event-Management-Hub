        ...
        <div class="my-account">
            ...
            <div class="tab-content profile-con open">
                <div class="personal-edit">
                    <a href="mehandi-profile-update.php"><span class="icon icon-pencile"></span>Edit Profile</a>
                </div>
                <div class="personal-information">
                    <div class="info-slide">
                        <p><span>Mehandi Class Name :</span><?php echo ucwords($mehandi['mehandi_class_name']); ?></p>
                    </div>
                    <div class="info-slide">
                        <p><span> Address :</span><?php echo ucwords($mehandi['address']); ?> <?php echo $mehandi['city']; ?></p>
                    </div>
                    <div class="info-slide">
                        <p><span>Contact Person Name :</span><?php echo ucwords($mehandi['contact_person']); ?></p>
                    </div>
                    <div class="info-slide">
                        <p><span>Mobile Number :</span><?php echo $mehandi['mobile']; ?></p>
                    </div>
                    <div class="info-slide">
                        <p><span>Email ID :</span><?php echo $mehandi['email']; ?></p>
                    </div>
                    <div class="info-slide">
                        <p><span>Mehandi Type :</span><?php echo $mehandi['type']; ?></p>
                    </div>
                    <div class="info-slide">
                        <p><span>Rate :</span>Rs.<?php echo $mehandi['rate']; ?>/-</p>
                    </div>
                </div>
            </div>
        </div>
