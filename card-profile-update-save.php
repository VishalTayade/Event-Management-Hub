...
if (sizeof($val->errors) > 0) {
    ...
    if ($card >= 1) {
        echo "<script>alert('Record updated successfully!');window.location='card-profile.php';</script>";
    } else {
        echo "<script>alert('Sorry! something went wrong...');window.location='card-profile-update.php?card_id=$card_id';</script>";
    }
}
?>
