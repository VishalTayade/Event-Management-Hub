        ...
        <div class="my-account">
            ...
            <div class="tab-content profile-con open">
                <div class="personal-edit">
                    <a href="hotel-profile-update.php"><span class="icon icon-pencile"></span>Edit Profile</a>
                </div>
                <div class="personal-information">
                    <div class="info-slide">
                        <p><span>Hotel Name :</span><?php echo ucwords($hotel['hotel_name']); ?></p>
                    </div>
                    <div class="info-slide">
                        <p><span>Hotel Address :</span><?php echo ucwords($hotel['address']); ?> <?php echo $hotel['city']; ?></p>
                    </div>
                    <div class="info-slide">
                        <p><span>Contact Person Name :</span><?php echo ucwords($hotel['contact_person']); ?></p>
                    </div>
                    <div class="info-slide">
                        <p><span>Mobile Number :</span><?php echo $hotel['mobile']; ?></p>
                    </div>
                    <div class="info-slide">
                        <p><span>Email ID :</span><?php echo $hotel['email']; ?></p>
                    </div>
                    <div class="info-slide">
                        <p><span>Seating Capacity :</span><?php echo $hotel['capacity']; ?> Peoples</p>
                    </div>
                    <div class="info-slide">
                        <p><span>Rate :</span>Rs.<?php echo $hotel['rate']; ?>/-</p>
                    </div>
                </div>
            </div>
        </div>
